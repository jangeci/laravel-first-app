                    ...
                    <form method="POST" action="{{route('register')}}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input name="name" type="text" class="form-control input-lg" id="name" aria-describedby="nameHelp" placeholder="Name" :value="old('name')" required autofocus autocomplete="name">
                            </div>
                            <div class="form-group col-md-12 mb-4">
                                <input type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Username" name="email" :value="old('email')" required autocomplete="username">
                            </div>
